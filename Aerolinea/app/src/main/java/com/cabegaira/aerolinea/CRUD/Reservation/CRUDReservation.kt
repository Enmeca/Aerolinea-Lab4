...
import com.cabegaira.aerolinea.adapters.RecyclerView_Adapter_Reservation


import com.cabegaira.aerolinea.Login
import com.cabegaira.aerolinea.R
import com.cabegaira.aerolinea.logic.Reservation
import com.cabegaira.aerolinea.data.Reservations

class CRUDReservation : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {


        var INSTANCIA: Reservations = Reservations.instance

        lateinit var lista: RecyclerView
        lateinit var adaptador: RecyclerView_Adapter_Reservation
        lateinit var ruta: Reservation
        var archived = ArrayList<Reservation>()
        var position: Int = 0
        ...
        override fun onCreate(savedInstanceState: Bundle?) {
            ...
            findViewById<SearchView>(R.id.reservation_search).setOnQueryTextListener(object : SearchView.OnQueryTextListener{
            ...
            val itemTouchHelperCallback = object : ItemTouchHelper.SimpleCallback(ItemTouchHelper.UP or ItemTouchHelper.DOWN or ItemTouchHelper.START or ItemTouchHelper.END, ItemTouchHelper.LEFT or ItemTouchHelper.RIGHT) {
                override fun onMove(recyclerView: RecyclerView, viewHolder: RecyclerView.ViewHolder, target: RecyclerView.ViewHolder): Boolean {
                    ...
                    Collections.swap(INSTANCIA.getReservations(), fromPosition, toPosition)
...
/*                        ruta = Reservation(INSTANCIA.getReservations()[position], INSTANCIA.getReservations()[position].lastName,
        ...
        private fun getListOfReservations() {
            ...
            for (p in INSTANCIA.getReservations()) {
                Nrutas.add(p)
            }
            adaptador = RecyclerView_Adapter_Reservation(Nrutas)
            lista.adapter = adaptador
        }
