...
class RecyclerView_Adapter_Airplane(private var items: ArrayList<Airplane>): RecyclerView.Adapter<RecyclerView.ViewHolder>(),
    Filterable {

    var itemsList: ArrayList<Airplane>? = null

    lateinit var mcontext: Context

    class AirplaneHolder(itemView: View) : RecyclerView.ViewHolder(itemView)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val AirplaneListView = LayoutInflater.from(parent.context).inflate(R.layout.template_airplane, parent, false)
        val sch = AirplaneHolder(AirplaneListView)
...
//        holder.itemView.findViewById<TextView>(R.id.tvFecha)?.text = item?.airplaneType
    ...
    override fun getFilter(): Filter {
        return object : Filter() {
            ...
            override fun publishResults(constraint: CharSequence?, results: FilterResults?) {
                itemsList = results?.values as ArrayList<Airplane>
