...
class CRUDFlight : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
...
/*                        ruta = Flight(INSTANCIA.getFlights()[position], INSTANCIA.getFlights()[position].lastName,
                ...
                override fun onChildDraw(c: Canvas, recyclerView: RecyclerView, viewHolder: RecyclerView.ViewHolder, dX: Float, dY: Float, actionState: Int, isCurrentlyActive: Boolean) {
                    ...
                    RecyclerViewSwipeDecorator.Builder(this@CRUDFlight, c, recyclerView, viewHolder, dX, dY, actionState, isCurrentlyActive)
                        .addSwipeLeftBackgroundColor(
                            ContextCompat.getColor(this@CRUDFlight,
                            R.color.Ruby_Red
                        ))
