...
class RecyclerView_Adapter_Ticket(private var items: ArrayList<Ticket>): RecyclerView.Adapter<RecyclerView.ViewHolder>(),
    Filterable {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val TicketListView = LayoutInflater.from(parent.context).inflate(R.layout.template_tickets, parent, false)
